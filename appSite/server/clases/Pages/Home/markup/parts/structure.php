	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="article">
				...
				<div class="meta">Estructura de <span>S!nt@x</span> y <span>APPs</span></div>
				<div class="body">
					<p>
						S!nt@x consta de varios directorios donde almacenar sus componentes y otros
...
<pre><?=self::array2list($arrSintaxFiles);?></pre>
					...
					<div class="col2">
						...
						directamente por el servidor web sin pasar por ninguno de los modulos de S!nt@x.<br />
						<code>includes/</code> contiene los ficheros de configuración de S!nt@x, así como todas
						...
						<code>zzModules/</code> contiene los módulos princiaples de S!nt@x.
					</div>
					<p>
...
<pre><?=self::array2list($arrAppFiles);?></pre>
				...
				<div class="body">
					<p>
						S!nt@x se encuentra organizado mediante puntos de entrada que proporcionan acceso a las
					...
					<p>
						...
						de ficheros de S!nt@x, pueden tener cualquier nombre, ser el índice el directorio
...
try {
	...
	header('HTTP/1.1 500 Internal Server Error',true,500);
				...
				<div class="body">
					<p>
						S!nt@x funciona mediante un conjunto de módulos encargados cada uno de una determinada tarea. Los módulos son
					...
					<div class="col2">
						S!nt@x consta de los siguientes módulos:
						<ul>
							<li>
							...
							<li>
								<a href="<?=BASE_URL?>modules/#css">css</a>: Recopilador de código css, llamado via etiqueta link.
							</li>
							<li>
